...
export class migration1683868279583 implements MigrationInterface {
    name = 'migration1683868279583'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP CONSTRAINT "PK_97441bb429dffea41940d6094e0"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD CONSTRAINT "PK_67f8a1e3be2ea0f17564b871dfb" PRIMARY KEY ("perm_id")
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP COLUMN "role_id"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD "role_id" uuid NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP CONSTRAINT "PK_67f8a1e3be2ea0f17564b871dfb"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD CONSTRAINT "PK_97441bb429dffea41940d6094e0" PRIMARY KEY ("perm_id", "role_id")
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP CONSTRAINT "PK_97441bb429dffea41940d6094e0"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD CONSTRAINT "PK_8cce8a13d529875e48b259a7f08" PRIMARY KEY ("role_id")
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP COLUMN "perm_id"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD "perm_id" uuid NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms" DROP CONSTRAINT "PK_8cce8a13d529875e48b259a7f08"
        `);
        await queryRunner.query(`
            ALTER TABLE "roles_perms"
            ADD CONSTRAINT "PK_97441bb429dffea41940d6094e0" PRIMARY KEY ("role_id", "perm_id")
        `);
        await queryRunner.query(`
